...
class MainWindow(Qt.QMainWindow):
    ...
    def load_and_prep_query_mesh(self, data):
        ...
        # Compare shapes
        self.show_similar_meshes_list(features_dict)

    def show_similar_meshes_list(self, feature_dict):
        w = AnotherWindow()
        w.show()
        # feature_df = QueryMatcher.init_from_query_mesh_features(feature_dict)
