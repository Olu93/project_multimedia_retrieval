...
if __name__ == "__main__":
    ...
    function_pipeline = [cosine] + ([cityblock] * count_hists) + ([cityblock] * count_skeletons)
    ...
    with io.open("stats/hyper_params_best_func_combo.csv", "w", newline='', encoding='utf-8') as csv_file:
