...
if __name__ == "__main__":
    ...
    weights_best_all_features = ([1]) + ([1] * count_hists) + ([1.47] * count_skeletons)
    function_pipeline_cowaeu = [cosine] + ([cityblock] * count_hists) + ([cityblock] * count_skeletons)
    ...
    k_all_db_results_cowaeu = pd.read_json("trash/k_all_db_results_cocici_bw.json")
